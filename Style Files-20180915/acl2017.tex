...
\[\maketitle
\begin{abstract}
  This document contains a report for Assignment 1 for CMPUT 650 at the 
  University of Alberta.  This assignment explores the use of language
  models in  
 the instructions for preparing a camera-ready
